...
class ResultSet extends AbstractResultSet
{
    ...
    public function __construct($returnType = self::TYPE_ARRAYOBJECT, $arrayObjectPrototype = null)
    {
        ...
        if ($this->returnType === self::TYPE_ARRAYOBJECT) {
            $this->setArrayObjectPrototype(
                ($arrayObjectPrototype) ?: new ArrayObject([], ArrayObject::ARRAY_AS_PROPS)
            );
        }
    }
    ...
    public function setArrayObjectPrototype($arrayObjectPrototype)
    {
        if (!is_object($arrayObjectPrototype)
            ...
            throw new \InvalidArgumentException('Object must be of type ArrayObject, '
                . 'or at least implement exchangeArray');
        }
