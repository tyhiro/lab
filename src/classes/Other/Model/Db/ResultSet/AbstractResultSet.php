...
use Countable;
use Iterator;
use Pattern\Model\Other\Db\ResultInterface;

class AbstractResultSet implements Iterator, ResultSetInterface
{
    /**
     ...
     *
     * @param  array|Iterator|ResultInterface $dataSource
     * @return ResultSet
    ...
    public function initialize($dataSource)
    {
        ...
        if (is_array($dataSource)) {
            ...
            throw new \InvalidArgumentException('DataSource provided is not an array, nor'
                . ' does it implement Iterator or IteratorAggregate');
        }
